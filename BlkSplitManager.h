...
#ifndef APLAYER_CPP_CLION_BLKSPLITMANAGER_H
#define APLAYER_CPP_CLION_BLKSPLITMANAGER_H
...
namespace aplayer {
    class BlkSplitManager : public BlkManager {
    public:
        BlkSplitManager(const char *path, uint64_t blk_size);
        ~BlkSplitManager();
    ...
    private:
        std::vector<FILE *> _split_files;
        uint64_t _position;
    };
}

#endif //APLAYER_CPP_CLION_BLKSPLITMANAGER_H
